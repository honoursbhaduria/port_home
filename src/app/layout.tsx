...
export const metadata: Metadata = {
  ...
  description:
    "Hi, I'm Honours Bhadauria — a Full-Stack Developer from Delhi, India. I build modern, scalable, and impactful web applications using Next.js, React, Tailwind CSS, Express.js, Node.js, and MongoDB. Always eager to learn, grow, and take on new challenges. Let's connect and create something impactful together! 🚀",
  keywords: [
    "Honours Bhadauria",
